...
@interface MKBucketTests : XCTestCase
...
describe(@"Bucket", ^{
    context(@"when doing operation", ^{
        ...
        __block MKBucket* empty;
        __block MKBucket* added1;
        __block MKBucket* added2;
        __block MKBucket* added1removed2;
        ...
        it(@"init or toJSON to serialze / deserialize data should contain same value", ^{
            ...
            MKBucket* bucket = [[MKBucket alloc] initWithJSONArray:array];
        ...
        it(@"group with 2 buckets should result in XOR operation", ^{
            MKBucket* result = [added1 group:added2];
        ...
        it(@"group with 2 buckets of different size should result in XOR operation", ^{
            ...
            MKBucket* added3 = [empty modifyItemsNumber:@1 xored:content3 hashed:hash3];
            
            MKBucket* result = [added1 group:added3];
