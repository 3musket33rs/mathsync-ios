...
@interface DeserializedDifferenceTests : XCTestCase
...
describe(@"ADeserializedDifference", ^{
    context(@"when newly created", ^{
        ...
        __block DeserializedDifference *difference = nil;
        __block id mockDifference = nil;
        __block id mockDeserializer = nil;
        
        beforeEach(^{
            mockDifference = [KWMock mockForProtocol:@protocol(Difference)];
            mockDeserializer = [KWMock mockForProtocol:@protocol(Deserializer)];
            const Byte elt1 = '1';
            const Byte elt2 = '2';
            ...
            difference = [[DeserializedDifference alloc] initWithDifference:mockDifference deserializer:mockDeserializer];
