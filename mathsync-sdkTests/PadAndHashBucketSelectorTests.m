...
@interface PadAndHashBucketSelectorTests : XCTestCase
...
describe(@"PadAndHashBucketSelector", ^{
    context(@"gives list of different hashes", ^{
        ...
        __block PadAndHashBucketSelector* padAndHashBucketSelector;
        __block id digester;
        ...
        beforeEach(^{
            ...
            padAndHashBucketSelector = [PadAndHashBucketSelector sharedPadAndHashBucketSelector:digester spread:3];
