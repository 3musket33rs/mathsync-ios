...
+(id)emptyBucket {
    return [[Bucket alloc] initWithItemsNumber:@0 xored:[NSData data] hashed:[NSData data]];
}
...
-(id)modifyItemsNumber:(NSNumber*)variation xored:(NSData*)content hashed:(NSData*)digested {
    ...
    return [[Bucket alloc] initWithItemsNumber:([NSNumber numberWithInt:([self.itemsNumber intValue] + [variation intValue])]) xored:newXored hashed:newHashed];
}
