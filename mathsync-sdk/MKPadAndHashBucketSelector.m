...
@implementation MKPadAndHashBucketSelector {
    NSUInteger _spread;
    id<MKDigester> _digester;
}

+(id)sharedPadAndHashBucketSelector:(id<MKDigester>)digester spread:(NSUInteger)spread {
    static MKPadAndHashBucketSelector *sharedMyPadAndHashBucketSelector = nil;
...
-(id)initWithDigester:(id<MKDigester>)digester spread:(NSUInteger)spread {
    if (spread < 1) {
        @throw [NSException
                exceptionWithName:@"IllegalArugument"
